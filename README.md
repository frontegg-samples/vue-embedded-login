![Vue.js Embedded Login Banner](/public/vue-banner.png)

# Vue.js embedded login sample

This sample showcases how to seamlessly add authentication and user management to your Vue.js app using Frontegg’s embedded login method.
